...
public class FightersList extends RecyclerView.Adapter<FightersList.FighterViewHolder> {
    ...
    public FighterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        fighterHolder.position = numberOfHolders;
    ...
    public static void setNumberOfHolders(int numberOfHolders) {
        FightersList.numberOfHolders = numberOfHolders;
    }
    ...
    class FighterViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(int listIndex) {
            ...
            fighterStyle.setText(userResponseDto.getStyle() + " " + userResponseDto.getLevel());
            viewHolderNumber.setText("Боец номер " + (position + 1));
            //пока в стринге
        }
